...
const About = () => {
  const [technicalSupportModalOpen, setTechnicalSupportModalOpen] = useState(false);
    ...
    <div className=" bg-white md:pt-44 pt-8  pb-4 my-3 px-12">
      <div className="flex md:flex-row flex-col gap-12 justify-center items-center  py-10">
        ...
        >
          ...
          {liveChatModalOpen && <LiveChatModal setOpenModal={setLiveChatModalOpen} />}
        </div>
        ...
        <div
          ...
          onClick={() => setTechnicalSupportModalOpen(true)}
        >
          ...
          {technicalSupportModalOpen && (
            <TechnicalSupportModal setOpenModal={setTechnicalSupportModalOpen} />
          )}
        </div>
